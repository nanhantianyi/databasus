...
For project-wide engineering philosophy, naming, and lint/format commands, see the root `AGENTS.md`. For the backend (Gin/GORM/Swagger) ruleset, see `backend/AGENTS.md`.
